...
def create_sample(sample, report_type, skus_sup, skus):
...
sample_df = create_sample(sample, report_type, skus_sup, skus)  #sample can be either a percent entered by the user OR a dictionary of weighted counts by node size
